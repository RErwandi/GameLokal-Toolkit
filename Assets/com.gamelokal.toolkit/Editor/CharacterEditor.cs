namespace GameLokal.Toolkit
{
	...
	public class CharacterEditor : Editor 
	{
		...
		protected const string CHARACTER_PREFAB_PATH = "GL Character";
		...
		[MenuItem("GameObject/GameLokal/Characters/Character", false, 0)]
		public static void CreateCharacter()
		{
			GameObject prefab = Resources.Load<GameObject>(CHARACTER_PREFAB_PATH);
